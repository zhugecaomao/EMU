...
uses
  ...
  Dialogs, Grids, DBGrids, ExtCtrls, DBCtrls, RzDBNav, StdCtrls;
...
begin
  ...
  dm1.qry1.ConnectionString:='Provider=Microsoft.Jet.OLEDB.4.0;Data Source='+path+';Persist Security Info=False';
  DM1.qry1.SQL.Clear;
