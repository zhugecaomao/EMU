...
uses
  ...
  ygxxgl in 'Form\ygxxgl.pas' {ygxxglfrm},
  khxxgl in 'Form\khxxgl.pas' {khxxglfrm},
  Supplier in 'Form\Supplier.pas' {supplierfrm},
  splbgl in 'Form\splbgl.pas' {splbglfrm},
  jldwgl in 'Form\jldwgl.pas' {jldwglfrm},
  spzlgl in 'Form\spzlgl.pas' {spzlglfrm},
  backup in 'Form\backup.pas' {backupfrm},
  restore in 'Form\restore.pas' {restorefrm},
  csh in 'Form\csh.pas' {cshfrm},
  qxgl in 'Form\qxgl.pas' {qxglfrm},
  jhdgl in 'Form\jhdgl.pas' {jhdglfrm},
  kctj in 'Form\kctj.pas' {kctjfrm},
  xsgl in 'Form\xsgl.pas' {xsglfrm},
  jhtj in 'Form\jhtj.pas' {jhtjfrm},
  xstj in 'Form\xstj.pas' {xstjfrm},
  mlfx in 'Form\mlfx.pas' {mlfxfrm},
  logoscreen in 'Form\logoscreen.pas' {logo};
...
begin
  ...
  begin
    ...
    Application.Title := 'PR / DO Manage System';
    {10.1 启动Splash屏幕 }
